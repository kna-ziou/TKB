  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs no-print">
      ...
      >
        ...
        <h3 id="clear-day-title" className="text-lg font-bold text-slate-900 mb-2">
          Xóa toàn bộ môn {dayLabel}?
        </h3>
        <p className="text-sm text-slate-600 leading-relaxed mb-6">
          Tất cả các tiết học của <span className="font-semibold text-slate-800">{dayLabel}</span> sẽ được xóa khỏi thời khóa biểu. Bạn có thể sử dụng tính năng <span className="font-medium text-indigo-600">Hoàn tác (Ctrl+Z)</span> để khôi phục lại bất kỳ lúc nào.
        </p>
